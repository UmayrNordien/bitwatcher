...
export default createStore({
 ...
 setAllNews(state, allNews){
  ...
  actions: {
     fetchWSJ(content){
      return fetch('https://bitwatcherapi-final.onrender.com/wsj').then((response) => response.json()).then((wsj) => {
 ...
 fetchUSBusiness(content){
  return fetch('https://bitwatcherapi-final.onrender.com/usbusiness').then((response)=> response.json()).then((usBusiness) => {
 ...
 fetchBitcoinNews(content){
  return fetch('https://bitwatcherapi-final.onrender.com/bitcoin').then((response) => response.json()).then((bitcoinNews) => {
 ...
 fetchAllNews(content){
  return fetch('https://bitwatcherapi-final.onrender.com/allnews').then((response) => response.json()).then((allNews) => {
